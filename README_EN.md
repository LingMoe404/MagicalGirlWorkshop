...
*   **OpenAI Codex / GPT**: Collaborated on implementation, debugging, testing, and documentation.
*   **Google Antigravity / Gemini**: Collaborated on solution exploration, code generation, and development assistance.

## 🤖 Behind the Scenes

This project is an **AI-Augmented Development** experiment led by **LingMoe404**.
LingMoe404 owns the product direction, architecture, requirements, reviews, and final decisions; **OpenAI Codex / GPT** and **Google Antigravity / Gemini** collaborate on implementation, debugging, testing, and documentation.
